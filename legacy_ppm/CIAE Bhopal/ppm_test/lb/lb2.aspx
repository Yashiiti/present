<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lb2.aspx.cs" Inherits="lb2" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 2) AND (dis_id = 1)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 1) AND ([q_level] = 2))">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="lb1.aspx" Text="Back" /></td>
                <td style="width: 95px; height: 26px">
        <asp:Button ID="Button2" runat="server" PostBackUrl="lb3.aspx" Text="Next" /></td>
                <td style="width: 49px; height: 26px; text-align: right">
                    <asp:Button ID="Button4" runat="server" PostBackUrl="lb_pic_help.aspx" Text="Picture Help" /></td>
