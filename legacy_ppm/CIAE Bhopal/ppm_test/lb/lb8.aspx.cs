...
public partial class lb8 : System.Web.UI.Page
{
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "SELECT wt FROM ppm_table WHERE dis_id = 1 AND q_level = 8 and q_option=" + "'" + RadioButtonList1.SelectedItem.Text + "'";
        ...
        y = Convert.ToInt32(Session["Page7"]);
        z = (x + y)/8;


        TextBox1.Text = Convert.ToString(z);

        Session["page8"] = Convert.ToInt32(TextBox1.Text);
