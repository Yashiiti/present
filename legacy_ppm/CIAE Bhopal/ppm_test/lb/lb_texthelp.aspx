<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lb_texthelp.aspx.cs" Inherits="lb_lb_texthelp" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Image ID="Image1" runat="server" ImageUrl="../texthelp/late_blight2PictureHelp.bmp" /><br />
        <br />
        <br />
