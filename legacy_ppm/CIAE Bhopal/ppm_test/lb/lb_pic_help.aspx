<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lb_pic_help.aspx.cs" Inherits="lb_lb_pic_help" %>
...
<body>
    ...
    <div>
        ...
        BETA Version 1.0<br />
        <br />
        <asp:Image ID="Image1" runat="server" ImageUrl="../picturehelp/late_blight2PictureHelp.bmp" /><br />
        <br />
