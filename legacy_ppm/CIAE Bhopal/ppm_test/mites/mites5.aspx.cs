...
public partial class lb8 : System.Web.UI.Page
{
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "SELECT wt FROM ppm_table WHERE dis_id = 8 AND q_level = 5 and q_option=" + "'" + RadioButtonList1.SelectedItem.Text + "'";
        ...
        Label1.Text = "The disease identified is MITES with confidance peercent of:";
