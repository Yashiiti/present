<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wg6.aspx.cs" Inherits="lb8" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 6) AND (dis_id = 5)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 5) AND ([q_level] = 6))">
        </asp:SqlDataSource>
        <br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="wg5.aspx" Text="Back" /></td>
        ...
        <asp:Button ID="Button3" runat="server" Font-Bold="True" PostBackUrl="../ppm1.aspx"
            Text="Home" Width="131px" /></td>
                <td style="width: 49px; height: 26px; text-align: right">
                    <asp:Button ID="Button6" runat="server" PostBackUrl="wg_pic_help.aspx" Text="Picture Help" /></td>
