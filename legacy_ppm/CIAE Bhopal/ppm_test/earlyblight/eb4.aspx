<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eb4.aspx.cs" Inherits="lb4" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 4) AND (dis_id = 2)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 2) AND ([q_level] = 4))">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="eb3.aspx" Text="Back" /></td>
                <td style="width: 95px; height: 26px">
        <asp:Button ID="Button2" runat="server" PostBackUrl="eb5.aspx" Text="Next" /></td>
