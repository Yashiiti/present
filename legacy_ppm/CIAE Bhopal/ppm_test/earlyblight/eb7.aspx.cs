...
public partial class lb7 : System.Web.UI.Page
{
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "SELECT wt FROM ppm_table WHERE dis_id = 2 AND q_level = 7 and q_option=" + "'" + RadioButtonList1.SelectedItem.Text + "'";
        ...
        Label1.Text = "The disease identified is EARLY BLIGHT with confidance peercent of:";
