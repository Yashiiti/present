<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dr_texthelp.aspx.cs" Inherits="lb_lb_texthelp" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Image ID="Image1" runat="server" ImageUrl="../texthelp/DryRotPictureHelp.bmp" /><br />
        <br />
        <br />
