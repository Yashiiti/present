<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gn7.aspx.cs" Inherits="lb7" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 7) AND (dis_id = 7)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 7) AND ([q_level] = 7))">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp; &nbsp;<br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="gn6.aspx" Text="Back" /></td>
