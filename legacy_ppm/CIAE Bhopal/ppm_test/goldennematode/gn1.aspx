<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gn1.aspx.cs" Inherits="lb" %>
...
<body>
    ...
    <div style="text-align: left">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 1) AND (dis_id = 7)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 7) AND ([q_level] = 1))">
        </asp:SqlDataSource>
        &nbsp;&nbsp;&nbsp;&nbsp;<br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="gn2.aspx" Text="Next" /></td>
                <td style="height: 26px">
                </td>
                <td style="width: 163px; height: 26px;">
                    <asp:Button ID="Button2" runat="server" PostBackUrl="gn_pic_help.aspx" Text="Picture Help" /></td>
