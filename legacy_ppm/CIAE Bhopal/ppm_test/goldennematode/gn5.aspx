<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gn5.aspx.cs" Inherits="lb5" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT DISTINCT Question FROM ppm_table WHERE (q_level = 5) AND (dis_id = 7)">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ppmConnectionString %>"
            SelectCommand="SELECT [q_option] FROM [ppm_table] WHERE (([dis_id] = 7) AND ([q_level] = 5))">
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="gn4.aspx" Text="Back" /></td>
                <td style="width: 95px; height: 26px">
        <asp:Button ID="Button2" runat="server" PostBackUrl="gn6.aspx" Text="Next" /></td>
                <td style="width: 49px; height: 26px; text-align: right">
                    <asp:Button ID="Button5" runat="server" PostBackUrl="gn_pic_help.aspx" Text="Picture Help" /></td>
                <td style="width: 32px; height: 26px">
                    <asp:Button ID="Button3" runat="server" PostBackUrl="gn_texthelp.aspx" Text="Text Help" /></td>
            </tr>
        </table>
        <br />
        &nbsp; &nbsp;&nbsp;&nbsp;
