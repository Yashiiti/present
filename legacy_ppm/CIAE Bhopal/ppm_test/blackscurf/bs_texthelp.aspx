<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bs_texthelp.aspx.cs" Inherits="lb_lb_texthelp" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Image ID="Image1" runat="server" ImageUrl="../texthelp/black_scurf1PictureHelp.bmp" /><br />
        <br />
        <br />
